...
class _HomeState extends State<Home> {
  ...
  void sendSoS() async {
    ...
    String emergencyContactNumber1 = "+918919706183";
  ...
  void _showCustomDialog(BuildContext context) {
    ...
    showDialog(
          ...
          builder: (context, setState) {
            ...
            dialogTimer ??= Timer.periodic(const Duration(seconds: 1), (timer) {
              ...
              if (secondsRemaining == 0) {
                ...
                sendSoS(); // Send the emergency alert
                // Navigate to StrokeEmergencyScreen after a short delay
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          // Timer widget at the top-right corner
                          Positioned(
                            top: 10,
                            right: 10,
                            child: Container(
      ...
      // Ensure timer is canceled if the dialog is closed externally.
