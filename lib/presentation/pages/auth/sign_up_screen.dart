...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void initState() {
    ...
    _emailFocusNode.addListener(() {
      setState(() {
        isKeyboardActive = _emailFocusNode.hasFocus ||
        ...
        child: BlocListener<SignUpBloc, SignUpState>(
          listener: (context, state) {
            if (state is SignUpSuccess) {
              // Navigate to user details screen on successful sign up.
    ...
    return CustomTextButton(
      onTap: () {
        ...
        if (userModel.email!.isNotEmpty &&
          ...
          _signUpBloc.add(SignUpButtonPressed(userModel: userModel));
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Center(child: Text("Please enter all the fields")),
